...
bool g_reached_blockpose= false;
...
float odom_y= odom_pose.pose.pose.position.y;
if(odom_y<=-9.0){
g_reached_blockpose= true;
 }  
...
int main(int argc, char** argv) {
    ...
    //here means robot has reached the elavator
